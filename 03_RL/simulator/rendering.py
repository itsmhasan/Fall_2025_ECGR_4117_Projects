...
import sys
import pyglet
from pyglet.gl import *  ## throws error
# from pyglet.gl import (
#     glPushMatrix, glPopMatrix, glTranslatef, glRotatef, glScalef,
#     glBegin, glEnd, glVertex2f, glVertex3f,
#     glColor4f, glLineWidth,
#     GL_LINES, GL_QUADS, GL_POLYGON, GL_TRIANGLES,
#     GL_BLEND, glEnable, glBlendFunc,
...
class Viewer(object):
    ...
    def render(self, return_rgb_array=False):
        ...
        if return_rgb_array:
            ...
            # Read raw bytes from pyglet (RGBA). Positive pitch; flip after.
            raw = image_data.get_data('RGBA', w * 4)
            arr = np.frombuffer(raw, dtype=np.uint8).reshape(h, w, 4)

            # Match the original orientation: flip vertically and drop alpha
            arr = arr[::-1, :, 0:3]
